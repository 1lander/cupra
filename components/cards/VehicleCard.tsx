...
export default function VehicleCard({ model, year, odometer, vin, nextService, location }: VehicleCardProps) {
  ...
  return (
    <DashboardItem title="Vehicle Info" icon={<MaterialCommunityIcons name="car" size={24} color={textColor} />}>
      ...
      <View style={styles.infoRow}>
        ...
        <Text style={[styles.value, { color: textColor }]}>{odometer.toLocaleString()} km</Text>
      </View>
